...
<svg width="${size[0]}" height="${size[1]}" viewBox="0 0 ${size[0]} ${size[1]}" version="1.1" xmlns="http://www.w3.org/2000/svg">
  <rect fill="url(#gradient)" x="0" y="0" width="${size[0]}" height="${size[1]}"/>
  <defs>
